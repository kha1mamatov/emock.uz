<!-- Enhanced Speaking Practice Page with Filters, View Switcher, and Stylish Appearance -->
@extends('layouts.app', ['class' => '', 'elementActive' => 'speaking'])

@section('content')
    <div class="content">
        <div class="container-fluid">
            <h4 class="mb-4 fw-bold text-info">
                <i class="nc-icon nc-headphones text-info"></i> Speaking Practice Tests
            </h4>
            ...
            <form method="GET">
                <div class="d-flex align-items-center row mb-4">
                    <div class="col-lg-4">
                        <select name="status" class="form-select shadow-sm border-info">
            ...
            @else
                <div id="test-view-mode">
                    ...
                    <div id="card-view" style="display:none;" class="d-flex flex-wrap gap-3">
